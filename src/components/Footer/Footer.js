  ...
  return (
    <footer className="footer" >
      ...
      <div className="footer__info" >
        ...
        <p className="footer__info-line" >Авторы иконок: Icongeek26, monkik, prettycons, Kiranshastry, Pixel perfect, Vitaly Gorbachev, Those Icons, Kiranshastry, Pixel perfect, Lyolya, Freepik, источник: www.flaticon.com</p>
      </div>
    </footer>
  )
