export const doctorDecsription = {
  ...
  clauses: [
    [
      "Я врач-стоматолог.",
      "А ещё я эстет. Есть много врачебных специальностей, где это качество личности остаётся невостребованным. Но мне повезло, я нахожу ему применение в своей ежедневной практике!",
